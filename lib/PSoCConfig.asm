...
export LoadConfig_inclinometer
export _LoadConfig_inclinometer
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_inclinometer
	lcall	LoadConfigTBL_inclinometer_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration inclinometer
;
;    Load configuration registers for inclinometer.
...
;               CUR_PP
;
_LoadConfig_inclinometer:
 LoadConfig_inclinometer:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_inclinometer_Bank0
    mov     X, <LoadConfigTBL_inclinometer_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_inclinometer_Bank1
    mov     X, <LoadConfigTBL_inclinometer_Bank1
