...
;;
;;     Routines in this file perform EEPROM User Module Read and
;;     Write operations.
;;
...
export   EEPROM_Start
export  _EEPROM_Start
export   EEPROM_Stop
export  _EEPROM_Stop
export   EEPROM_bE2Write
export  _EEPROM_bE2Write
export   EEPROM_E2Read
export  _EEPROM_E2Read

export   EEPROM_RESERVED

;-----------------------------------------------------------------
;  Allocate the EEPROM EEPROM device in Flash memory
...
;-----------------------------------------------------------------
AREA  EEPROM_AREA   (ROM,ABS,CON)
   ORG   EEPROM_START_ADDR

_EEPROM_RESERVED::
 EEPROM_RESERVED::     blkb     40h
...
;
;  DESCRIPTION:
;     Start routine for the EEPROM user module.  This routine is
...
;
;  DESCRIPTION:
;     Stop routine for the EEPROM user module.  This routine is
;     a place holder for conformance and consistency.
;
;-----------------------------------------------------------------------------
;
...
;        void EEPROM_bE2Write( WORD wAddr, BYTE * pbData, WORD wByteCount,
;                                        CHAR cTemperature );
;
...
;
;  RETURNS:    EEPROM_NOERROR, EEPROM_FAILURE, or
;              EEPROM_STACKOVERFLOW
;
;  SIDE EFFECTS: 
...
IF (CPU_F)     ;only save CPU flag if NOT CY8C25/26xxx PSoC devices
   ...
   push  A
ENDIF
   mov   A, >EEPROM_START_BLOCK          ; push the FirstBlockID - MSB
   push  A
   mov   A, <EEPROM_START_BLOCK          ; push the FirstBlockID - LSB
   push  A
...
;        void EEPROM_E2Read( WORD wAddr, BYTE * pbDataDest, WORD wByteCount );
;
;     Easiest method to call from assembly is as follows:
