...
export LoadConfigTBL_inclinometer_Bank1
export LoadConfigTBL_inclinometer_Bank0
export LoadConfigTBL_inclinometer_Ordered
AREA lit(rom, rel)
LoadConfigTBL_inclinometer_Bank0:
;  Instance name EEPROM, User Module E2PROM
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_inclinometer_Bank1:
;  Instance name EEPROM, User Module E2PROM
;  Instance name LCD, User Module LCD
...
LoadConfigTBL_inclinometer_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[03h], 55h		; Port_0_DriveMode_2 register (PRT0DM2)
